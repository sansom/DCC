            ...
            if (z.length) z.on(_click + ".i mouseover.i mouseout.i " + _touch, function (b) {
                ...
                if (!c[n]) {
                    if (d == _click) {
                        ...
                        A(a, !1, !0)
                    } else B && (/ut|nd/.test(d) ? (h[_remove](v), e[_remove](w)) : (h[_add](v), e[_add](w))); if (_mobile) b.stopPropagation();
                    else return !1
                }
            });
            ...
            d.on(_click + " mousedown mouseup mouseover mouseout " + _touch, function (b) {
                ...
                if (!c[n]) {
                    if (d == _click) A(a, !1, !0);
                        ...
                        else h[_remove](e + " " + t); if (z.length && B && e == v) z[/ut|nd/.test(d) ? _remove : _add](w)
